...
<head>
  ...
  <title>AEMWIA | <?php echo"$fullname"; ?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Update Member <?php echo"$stdid"; ?>
      
      </h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Update Member <?php echo"$stdid"; ?></li>
      </ol>
    </section>
...
?>
              <form action="up_mem.php?ref=<?php echo"$stdid"; ?>" method="post">
            ...
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-default" name="newstd" id="sendEmail">Update Member
