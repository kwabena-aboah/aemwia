...
<head>
  ...
  <title>Harrison High | <?php echo"$quid"; ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Parent/Teacher</b> System</span>>
    </a>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By Kelvin Owusu and Otu Frank</a>.</strong> All rights
    reserved.
  </footer>
